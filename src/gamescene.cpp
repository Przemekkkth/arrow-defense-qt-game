...
void GameScene::handlePlayerInput()
{
    ...
    const bool left = m_keys[KEYBOARD::KeysMapper[Qt::Key_Left]]->m_pressed;
    const bool right = m_keys[KEYBOARD::KeysMapper[Qt::Key_Right]]->m_pressed;
    const bool up = m_keys[KEYBOARD::KeysMapper[Qt::Key_Up]]->m_pressed;
    const bool down = m_keys[KEYBOARD::KeysMapper[Qt::Key_Down]]->m_pressed;
    if (left || right || up || down) {
        m_gameManager.checkKey(left, right, up, down);
    }
}
